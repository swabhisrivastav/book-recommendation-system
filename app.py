...
@app.route('/byauthor_books',methods=['post'])
def search_books_by_author():
    author_name = request.form.get('user_input')
    # Filter the books by the specified author
    unique_books = books.drop_duplicates(subset='Book-Title')
    filtered_books = unique_books[unique_books['Book-Author'].str.contains(author_name, case=False, na=False)]
    data = []
